...
public class Level : MonoBehaviour
{
    ...
    public float PIPE_MOVE_SPEED = 30f;
    ...
    private void SpawnInitialClouds()
    {
        ...
        cloudTransform = Instantiate(GetCloudPrefabTransform(), new Vector3(0, CLOUD_SPAWN_Y_POSITION, 0),
            Quaternion.identity);
    ...
    private void HandleClouds()
    {
        ...
        if (cloudSpawnTimer < 0)
        {
            ...
            Transform cloudTransform = Instantiate(GetCloudPrefabTransform(),
                new Vector3(CLOUD_SPAWN_X_POSITION, CLOUD_SPAWN_Y_POSITION, 0), Quaternion.identity);
            cloudList.Add(cloudTransform);
        }
    ...
    private void SpawnInitialGround()
    {
        ...
        groundTransform = Instantiate(GameAssets.GetInstance().pfGround, new Vector3(0, groundY, 0),
            Quaternion.identity);
    ...
    private void HandleGround()
    {
        foreach (Transform groundTransform in groundList)
        {
            ...
            if (groundTransform.position.x < GROUND_DESTROY_X_POSITION)
            {
                ...
                float groundWidth = 192f;
                groundTransform.position = new Vector3(rightMostXPosition + groundWidth, groundTransform.position.y,
    ...
    public class Pipe
    {
        ...
        public void Move()
        {
            pipeHeadTransform.position += new Vector3(-1, 0, 0) * Level.instance.PIPE_MOVE_SPEED * Time.fixedDeltaTime;
            pipeBodyTransform.position += new Vector3(-1, 0, 0) * Level.instance.PIPE_MOVE_SPEED * Time.fixedDeltaTime;
        }
